"""
Generate the final K=5 training partitions from the training labels only.
...
OUT_ROOT = Path("data/fl_clients/final_partitions/k_5")
SUMMARY_PATH = Path("results/fl_partitions/final_partitions/partition_summary.csv")
