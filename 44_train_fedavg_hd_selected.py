...
# Full grid: 3 labels x 5 conditions = 15 runs against the OURS-partitioner set at
# data/fl_clients/hd_selected_partitions/k_5. Seeds here are the directory labels
